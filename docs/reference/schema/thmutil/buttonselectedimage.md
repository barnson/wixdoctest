...
sidebar_position: 8
---
# ButtonSelectedImage element (Thmutil extension)
Defines a button image that is used when the control is selected. ButtonImage and ButtonHoverImage are required with ButtonSelectedImage.
