...
| [OnCachePackageNonVitalValidationFailure()](#oncachepackagenonvitalvalidationfailure_nop) | Called by the engine, raises the «see E:WixToolset.Mba.Core.BootstrapperApplication.CachePackageNonVitalValidationFailure» event. |
